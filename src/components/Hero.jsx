...
const Hero = () => {
  return (
    <div className='w-full bg-primary/10 py-40'>
      <div className="container mx-auto w-full px-10">
        ...
        <div className="py-10 space-x-10 flex justify-center items-center font-semibold">
          <button className='px-10 py-3 bg-primary hover:bg-primary/90 cursor-pointer rounded-full'>Contact Me</button>
          <button className='px-10 py-3 bg-dark hover:bg-dark/90 rounded-full cursor-pointer text-amber-50'>Digital Market</button>
        </div>

        <div className="max-w-5xl flex mx-auto justify-center items-center overflow-hidden">
          <img className='rounded-xl object-cover' src={assets.heroImg} alt="hero-image" />
        </div>
      </div>
    </div>
  )
